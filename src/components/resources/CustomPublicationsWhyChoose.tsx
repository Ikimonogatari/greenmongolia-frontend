...
const CustomPublicationsWhyChoose = () => {
    ...
    <>
      <div className="choose-us-style-two-area overflow-hidden default-padding-top">
        <div className="container">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 pr-100 pr-md-15 pr-xs-15 pb-120 pb-md-60 pb-xs-60">
            ...
            <div className="col-xl-5 offset-xl-1 col-lg-6 col-md-12 col-sm-12">
              <div className="choose-us-style-two-content">
                ...
                <div className="choose-us-style-two-info">
                  ...
                  <div className="thumb">
                    <Image src="/assets/img/thumb/4.jpg" alt="Image Not Found" className="h-auto w-100" width={1200} height={900} />
...
export default CustomPublicationsWhyChoose;
