                ...
                <ul>
                  <li>
                    <div className="content">
                      ...
                      <a href={`tel:${tFooter("contactInfo.phoneValue")}`}>
                        {tFooter("contactInfo.phoneValue")}
                      </a>
                    </div>
                  </li>
                  <li>
                    <div className="info">
                      ...
                      <p>{tFooter("contactInfo.addressValue")}</p>
                    </div>
                  </li>
                  <li>
                    <div className="info">
                      <h5 className="title">{t("info.emailTitle")}</h5>
                      <a href={`mailto:${tFooter("contactInfo.emailValue")}`}>
                        {tFooter("contactInfo.emailValue")}
                      </a>
                    </div>
                  </li>
                </ul>
