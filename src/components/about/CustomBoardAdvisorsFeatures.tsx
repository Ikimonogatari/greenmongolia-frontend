...
const CustomBoardAdvisorsFeatures = () => {
    ...
    },
    {
      ...
      featureData: [
        ...
        },
        {
          id: 4,
          thumb: "12.png",
          title: t("responsibilities.responsibility4")
        }
      ]
    }
  ];
              ...
              <div className="info">
                ...
                <div className="button">
                  <Link onClick={() => setOpen(true)} href="#" scroll={false} className="popup-youtube text-play-button mt-20">
                    ...
                    <span><i className="fas fa-play" /> {t("watchVideo")}</span>
                  </Link>
                </div>
              </div>
            </div>
...
export default CustomBoardAdvisorsFeatures;
