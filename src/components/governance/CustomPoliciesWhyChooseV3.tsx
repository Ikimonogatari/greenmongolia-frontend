...
const CustomPoliciesWhyChooseV3 = () => {
  const t = useTranslations("PoliciesStrategies");

  const fields = [
    t("financialPolicies.title"),
    t("environmentalSocialPolicies.title"),
    t("strategicFramework.title"),
    t("compliance.title")
  ];
...
export default CustomPoliciesWhyChooseV3;
