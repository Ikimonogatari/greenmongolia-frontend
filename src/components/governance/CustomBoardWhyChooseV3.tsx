...
const CustomBoardWhyChooseV3 = () => {
  const t = useTranslations("GMHBoard");

  const fields = [
    t("boardOfDirectors.responsibility1"),
    t("boardOfDirectors.responsibility2"),
    t("managementTeam.title"),
    t("boardOfDirectors.separation")
  ];
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 offset-lg-6 pl-60 pl-md-15 pl-xs-15">
              <h2 className="title">{t("boardOfDirectors.title")}</h2>
              <p>{t("introduction")}</p>
...
export default CustomBoardWhyChooseV3;
