      ...
      featureData: [
        {
          id: 3,
          thumb: "11.png",
          title: t("boardOfDirectors.responsibility1")
        },
        {
          id: 4,
          thumb: "12.png",
          title: t("boardOfDirectors.responsibility2")
        }
      ]
    }
  ];
          ...
          <div className="feature-style-two-items">
            <div className="feature-style-two info text-light bg-dark" style={{ backgroundImage: 'url(/assets/img/shape/19.png)' }}>
              <div className="info">
                ...
                <h2 className="title mb-25">{t("boardOfDirectors.title")}</h2>
                <p>{t("introduction")}</p>
                <div className="button">
                  <Link onClick={() => setOpen(true)} href="#" scroll={false} className="popup-youtube text-play-button mt-20">
                    <div className="effect" />
                    <span><i className="fas fa-play" /> {t("boardOfDirectors.title")}</span>
                  </Link>
                </div>
              </div>
            </div>
...
export default CustomBoardFeatureV2;
