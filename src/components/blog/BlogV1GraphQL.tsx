                ...
                <div className="container">
                    <div className="blog-items">
                        <div className="row">
                            ...
                            {featuredArticle && (() => {
                                const translation = getTranslation(featuredArticle.translations, languageCode);
                                const imageUrl = getDirectusImageUrl(featuredArticle.image || featuredArticle.cover_image);
                                const dateInfo = formatDate(featuredArticle.date_created);

                                return (
                                    <div className="col-lg-8 single-item" key={featuredArticle.id}>
                                        <div className="item">
                                            <div className="thumb">
                                                <Link href={`/blog-with-sidebar/${featuredArticle.id}`}>
                                                    {imageUrl ? (
                                                        <Image 
                                                            src={imageUrl} 
                                            ...
                                            <div className="info">
                                                <div className="meta">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <Link href="#">{featuredArticle.tags?.length || 0} Tags</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <h2>
                                                ...
                                                <Link className="btn-simple" href={`/blog-with-sidebar/${featuredArticle.id}`}>
                                                    <i className="fas fa-angle-right" /> {t("latestNews.continueReading")}
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="info">
                                                <div className="meta">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <i className="fas fa-comments" />
                                                            <Link href="#">{article.tags?.length || 0} Tags</Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <h4>
                                                ...
                                                <Link className="btn-simple" href={`/blog-with-sidebar/${article.id}`}>
                                                    <i className="fas fa-angle-right" /> {t("latestNews.continueReading")}
                                                </Link>
                                            </div>
                                        </div>
